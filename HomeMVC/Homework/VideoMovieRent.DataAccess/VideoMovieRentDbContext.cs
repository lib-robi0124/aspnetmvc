    ...
    public class VideoMovieRentDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>()
                ...
                new Movie { Id = 6, Title = "Midnight in Paris", Genre = Genre.Romance, Language = Language.French, IsAvailable = true, ReleaseDate = new DateTime(2001, 4, 25), Length = new TimeSpan(2, 2, 0), AgeRestriction = 12, Quantity = 3, ImagePath = "/images/movies/paris.jpg" },
