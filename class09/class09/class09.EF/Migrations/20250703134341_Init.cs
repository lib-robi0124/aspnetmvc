    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2002, 7, 3, 15, 43, 40, 472, DateTimeKind.Local).AddTicks(4703), "Bob", "Bobsky" },
                    { 2, 2, new DateTime(1997, 7, 3, 15, 43, 40, 472, DateTimeKind.Local).AddTicks(4756), "Jill", "Wayne" },
                    { 3, 1, new DateTime(2007, 7, 3, 15, 43, 40, 472, DateTimeKind.Local).AddTicks(4759), "John", "Doe" }
                });
