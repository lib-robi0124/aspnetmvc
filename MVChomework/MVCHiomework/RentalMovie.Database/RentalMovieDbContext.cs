    ...
    public class RentalMovieDbContext(DbContextOptions<RentalMovieDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>()
                .HasData(
                new Movie { Id = 1, Title = "Neon Shadows", Genre = Genre.SciFi, Language = Language.Japanese, IsAvailable = true, ReleaseDate = new DateTime(2012, 10, 23), Length = new TimeSpan(2, 23, 0), AgeRestriction = 13, Quantity = 5, ImagePath = "/images/movies/sci-fi.jpg" },
                new Movie { Id = 2, Title = "The Silent Forest", Genre = Genre.Thriller, Language = Language.Korean, IsAvailable = true, ReleaseDate = new DateTime(2019, 5, 30), Length = new TimeSpan(2, 12, 0), AgeRestriction = 18, Quantity = 3, ImagePath = "/images/movies/thriller.jpg" },
                new Movie { Id = 3, Title = "Quantum Paradox", Genre = Genre.SciFi, Language = Language.English, IsAvailable = false, ReleaseDate = new DateTime(2012, 4, 11), Length = new TimeSpan(2, 23, 0), AgeRestriction = 13, Quantity = 0, ImagePath = "/images/movies/sci-fi.jpg" },
                new Movie { Id = 4, Title = "Celestial Voyage", Genre = Genre.Adventure, Language = Language.French, IsAvailable = true, ReleaseDate = new DateTime(2014, 11, 7), Length = new TimeSpan(2, 49, 0), AgeRestriction = 10, Quantity = 4, ImagePath = "/images/movies/adventure.jpg" },
                new Movie { Id = 5, Title = "Whispers in the Dark", Genre = Genre.Horror, Language = Language.Spanish, IsAvailable = true, ReleaseDate = new DateTime(1980, 5, 23), Length = new TimeSpan(2, 26, 0), AgeRestriction = 18, Quantity = 2, ImagePath = "/images/movies/horror.jpg" },
                new Movie { Id = 6, Title = "Midnight in Paris", Genre = Genre.Romance, Language = Language.French, IsAvailable = true, ReleaseDate = new DateTime(2001, 4, 25), Length = new TimeSpan(2, 2, 0), AgeRestriction = 12, Quantity = 3, ImagePath = "/images/movies/romance.jpg" },
                new Movie { Id = 7, Title = "The Forgotten Letter", Genre = Genre.Mystery, Language = Language.German, IsAvailable = false, ReleaseDate = new DateTime(1997, 12, 20), Length = new TimeSpan(1, 56, 0), AgeRestriction = 13, Quantity = 0, ImagePath = "/images/movies/mystery.jpg" },
                new Movie { Id = 8, Title = "Crimson Peak", Genre = Genre.Horror, Language = Language.English, IsAvailable = true, ReleaseDate = new DateTime(2017, 2, 24), Length = new TimeSpan(1, 44, 0), AgeRestriction = 17, Quantity = 6, ImagePath = "/images/movies/horror.jpg" },
                new Movie { Id = 9, Title = "Rogue Agent", Genre = Genre.Action, Language = Language.Mandarin, IsAvailable = true, ReleaseDate = new DateTime(2010, 7, 16), Length = new TimeSpan(2, 28, 0), AgeRestriction = 13, Quantity = 7, ImagePath = "/images/movies/action.jpg" },
                new Movie { Id = 10, Title = "The Alchemist's Daughter", Genre = Genre.Fantasy, Language = Language.Spanish, IsAvailable = true, ReleaseDate = new DateTime(2006, 10, 11), Length = new TimeSpan(1, 58, 0), AgeRestriction = 15, Quantity = 2, ImagePath = "/images/movies/fantasy.jpg" });
